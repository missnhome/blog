...
function filterWriteups() {
          ...
          for (var i = 0; i < links.length; i++) {
              ...
              var content = links[i].dataset.content.toLowerCase();
               var writeup="";
             if(endsWith( link,".md"))
                 writeup=loadWriteupContent(link,"html");
          ...
          for (var i = 0; i < links.length; i++) {
              ...
              if(i==0)  
                 if(endsWith(   link.href ,".md"))
                  loadWriteupContent(  link.href ,'html'); // Pass the full title to loadWriteupContent
                     else
              ...
              link.addEventListener('click', function(event) {
                  ...
                  loadWriteupContent(this.href,'html'); // Pass the full title to loadWriteupContent
                     else
...
var tempElement = document.createElement('div');
  ...
  if( ulElement.style.display == "block")
   ulElement.style.display = "none";
    ...
    function filterWriteups() {
            ...
            function loadWriteupContent(writeupUrl,tag) {
                fetch(writeupUrl)
                    .then(response => {
                        if (!response.ok) {
 ...
 // Load the content for a specific URL
  ...
  loadWriteupContent(specificURL,"html");
